...
public interface UserAccountDocsj {
    ...
    @PostMapping("/signup")
    TokenProvider.Token registerUser(@RequestBody @Valid SignupDto request);
    ...
    @PostMapping("/signin")
    TokenProvider.Token loginUser(@RequestBody @Valid LoginDto request);
    ...
    @DeleteMapping("/me")
    void unregisterUser(@RequestHeader("Authorization") String authorizationHeader);
}
